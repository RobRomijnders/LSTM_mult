...
Inspriration after Rajiv Shah's rnn_addition
...
for k in range(1,max_iterations):
    ...
    _,cost_train = sess.run([train_op,loss],feed_dict=train_dict)   #perform an update on the parameters
